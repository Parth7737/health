...
Route::group(['middleware'=>['hospital','auth'],'namespace' => 'App\Http\Controllers\Hospital', 'prefix' => 'hospital', 'as' => 'hospital.'], function () {
    ...
    Route::group(['middleware' => ['permission:view-patient-management'], 'prefix' => 'patient-management', 'as' => 'patient-management.'], function () {
        ...
        Route::get('patient-scheme-profile/{patient}', 'PatientManagementController@patientSchemeProfile')->name('patient-scheme-profile.show');
        Route::post('patient-scheme-profile/{patient}', 'PatientManagementController@patientSchemeProfileUpdate')->name('patient-scheme-profile.update');
    ...
    Route::group(['prefix' => 'pharmacy', 'as' => 'pharmacy.'], function () {
        ...
        // Pharmacy GRN
        Route::middleware(['permission:view-pharmacy-grn'])->group(function () {
