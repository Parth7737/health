...
$(function () {
  ...
  var bsRangePickerBasic = $('#bs-rangepicker-basic'),
    ...
    bsRangePickerSingle2 = $('#bs-rangepicker-single-2'),
    bsRangePickerSecond = $('#bs-rangepicker-second'),
    bsRangePickerThird = $('#bs-rangepicker-third'),
    bsRangePickerForth = $('#bs-rangepicker-forth'),
    bsRangePickerFive = $('#bs-rangepicker-five'),
    bsRangePickerSix = $('#bs-rangepicker-six'),
  ...
  if (bsRangePickerSecond.length) {
    bsRangePickerSecond.daterangepicker({
      singleDatePicker: true,
      locale: {
        format: 'YYYY-MM-DD'
      },
  ...
  if (bsRangePickerThird.length) {
    bsRangePickerThird.daterangepicker({
      singleDatePicker: true,
      locale: {
        format: 'YYYY-MM-DD'
      },
  ...
  if (bsRangePickerForth.length) {
    bsRangePickerForth.daterangepicker({
      singleDatePicker: true,
      locale: {
        format: 'YYYY-MM-DD'
      },
  ...
  if (bsRangePickerFive.length) {
    bsRangePickerFive.daterangepicker({
      singleDatePicker: true,
      locale: {
        format: 'YYYY-MM-DD'
      },
  ...
  if (bsRangePickerSix.length) {
    bsRangePickerSix.daterangepicker({
      singleDatePicker: true,
      locale: {
        format: 'YYYY-MM-DD'
      },
