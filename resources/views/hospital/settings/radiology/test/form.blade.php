...
<div class="modal-header">
    <h5 class="modal-title" id="view_modal_dataModelLabel">{{ !$id ? 'Add' : 'Edit'}} Radiology Test</h5>
    ...
    <div class="modal-body">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-6">
                ...
                <select name="radiology_category_id" id="radiology_category_id" class="form-control select2-modal">
                    <option value="">Select Category</option>
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" {{ (isset($data) && (int) @$data->radiology_category_id === (int) $category->id) ? 'selected' : '' }}>{{ $category->name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-md-12 mt-1">
                ...
                <select name="radiology_parameter_ids[]" id="radiology_parameter_ids" class="form-control select2-modal" multiple>
