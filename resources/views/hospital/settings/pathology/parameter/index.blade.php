...
@section('title','Pathology Parameters')
@section('page_header_icon', '🧪')
@section('page_subtitle', 'Manage Pathology Parameters')
@section('page_header_actions')
@can('create-pathology-parameter')
    <button class="btn btn-info adddata" data-id="">+ Add Parameter</button>
@endcan
@endsection
@section('content')
