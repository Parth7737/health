...
@section('title','Medicine Routes')
@section('page_header_icon', '📋')
@section('page_subtitle', 'Manage Medicine Routes')
@section('page_header_actions')
@can('create-frequency')
    <button class="btn btn-info adddata" data-id="">+ Add Medicine Route</button>
@endcan
@endsection
@section('content')
