...
@section('title','Visitor Purposes')
@section('page_header_icon', '👥')
@section('page_subtitle', 'Manage Visitor Purposes')
@section('page_header_actions')
@can('create-visitor-purposes')
    <button class="btn btn-info adddata" data-id="">+ Add Visitor Purpose</button>
@endcan
@endsection
@section('content')
