...
@section('title','Appointment Priorities')
@section('page_header_icon', '📋')
@section('page_subtitle', 'Manage Appointment Priorities')
@section('page_header_actions')
@can('create-appointment-priorities')
    <button class="btn btn-info adddata" data-id="">+ Add Appointment Priority</button>
@endcan
@endsection
@section('content')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-3">
          @include('hospital.settings.front-office.submenu')
        </div>
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body">
