@if($licenses->count() > 0)
<div id="licensesCard" class="eo-card">
   <div class="eo-card-hdr">
      <h3 class="eo-card-title"><i class="fas fa-certificate" style="color:#ffb74d"></i> Statutory licenses</h3>
   ...
   <div class="eo-card-body">
      @foreach($licenses as $key => $value) 
         ...
         <div class="eo-license-group">
            <div class="eo-license-group-title">{{$value->name}}</div>
         ...
         <tr>
            ...
            <td>
            <div class="input-group input-group-merge lierror eo-license-date">
            ...
            <td>
               <div class="file-upload-section lierror eo-license-document">
            ...
            <td>
               <input type="text"
                  ...
                  class="form-control eo-license-remark"
                  placeholder=""/>
            </td>
         </tr>
         @endforeach
