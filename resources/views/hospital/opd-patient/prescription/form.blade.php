...
<style>
    ...
    #opdPrescriptionForm .select2-container {
        width: 100% !important;
        max-width: 100%;
    }

    #opdPrescriptionForm .select2-selection {
        max-width: 100%;
        overflow: hidden;
    }
...
<div class="modal-header">
    <h5 class="modal-title">{{ $prescription ? 'Edit Prescription' : 'Add Prescription' }} - {{ $opdPatient->case_no }}</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>


    <div class="modal-body">
        <form id="opdPrescriptionForm" data-store-url="{{ route('hospital.opd-patient.prescription.store', ['opdPatient' => $opdPatient->id]) }}" data-load-dosages-url="{{ route('hospital.opd-patient.prescription.load-dosages') }}" data-simple-notes="1">
                    ...
                    <div class="prescription-meta-card">
                        <div class="prescription-notes-grid">
                            <div>
                                ...
                                <textarea class="form-control" id="prescription_header_note" name="header_note" rows="3" placeholder="Short note for patient...">{{ $prescription?->header_note }}</textarea>
                            </div>
                            <div>
                                <label class="form-label">Footer Note</label>
                                <textarea class="form-control" id="prescription_footer_note" name="footer_note" rows="3" placeholder="Advice / follow-up note...">{{ $prescription?->footer_note }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" form="opdPrescriptionForm" class="btn btn-primary save-prescription-btn">{{ $prescription ? 'Update Prescription' : 'Save Prescription' }}</button>
    </div>
