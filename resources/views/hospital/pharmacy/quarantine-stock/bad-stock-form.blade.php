<div class="modal-header bg-warning">
    <h5 class="modal-title text-dark">Adjust Quarantine Stock</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form method="POST" id="bad-quarantine-stock-form">
    <div class="modal-body">
        ...
        <div class="mb-2">
            <label class="form-label">Quarantine Qty</label>
            <input type="text" class="form-control" value="{{ $batch->reserved_qty }}" readonly>
        </div>
        <div class="mb-2">
            <label class="form-label">Bad Qty <span class="text-danger">*</span></label>
            <input type="number" step="0.01" min="0.01" max="{{ $batch->reserved_qty }}" class="form-control" name="quantity" required>
        </div>
        <div>
