...
<head>
    ...
    <title>IPD Prescription #{{ $prescription->id }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="sheet">
        ...
        <div class="top">
            ...
            <div class="meta">
                <div><strong>IPD Prescription #{{ $prescription->id }}</strong></div>
                <div>Date: {{ optional($prescription->created_at)->format('d-m-Y') ?? '-' }}</div>
        ...
        <div class="grid">
            ...
            <div class="box">
                ...
                <div><strong>Weight:</strong> {{ $allocation->weight ?? '-' }}</div>
                <div><strong>BP:</strong> {{ $allocation->bp ?? '-' }}</div>
