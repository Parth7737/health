<div class="modal-header">
    <h5 class="modal-title">IPD Prescription #{{ $prescription->id }}</h5>
    <div class="d-flex align-items-center gap-2 ms-auto">
        <button type="button" class="btn btn-info btn-sm edit-ipd-prescription-btn" title="Edit Prescription"
        ...
        <button type="button" class="btn btn-info btn-sm print-ipd-prescription-btn" title="Print Prescription"
        ...
        <button type="button" class="btn btn-info btn-sm delete-ipd-prescription-btn" title="Delete Prescription"
...
<div class="modal-body">
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-6">
            <div class="border rounded p-3 h-100 bg-light-subtle">
                <p class="mb-1"><strong>Admission No:</strong> {{ $allocation->admission_no ?? '-' }}</p>
                <p class="mb-1"><strong>Date:</strong> {{ optional($prescription->created_at)->format('d-m-Y h:i A') ?? '-' }}</p>
                <p class="mb-1"><strong>Consultant:</strong> {{ $prescription->doctor?->full_name ?? '-' }}</p>
                <p class="mb-0"><strong>Valid Till:</strong> {{ optional($prescription->valid_till)->format('d-m-Y') ?? '-' }}</p>
            </div>
        </div>
