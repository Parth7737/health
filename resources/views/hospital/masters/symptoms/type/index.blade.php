...
@section('title','Symptoms Types')
@section('page_header_icon', '🩺')
@section('page_subtitle', 'Manage Symptoms Types')
@section('page_header_actions')
@can('create-symptoms-type')
    <button class="btn btn-info adddata" data-id="">+ Add Type</button>
@endcan
@endsection
@section('content')
