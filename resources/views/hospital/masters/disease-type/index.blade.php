...
@section('title','Disease Types')
@section('page_header_icon', '🏥')
@section('page_subtitle', 'Manage Disease Types')
@section('page_header_actions')
@can('create-disease-types')
    <button class="btn btn-info adddata" data-id="">+ Add Disease Type</button>
@endcan
@endsection
@section('content')
