...
@section('title','Allergy Reactions')
@section('page_header_icon', '⚠')
@section('page_subtitle', 'Manage Allergy Reactions')
@section('page_header_actions')
@can('create-allergy-reaction')
    <button class="btn btn-info adddata" data-id="">+ Add Allergy Reaction</button>
@endcan
@endsection
@section('content')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-3">
          @include('hospital.masters.submenu')
        </div>
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body">
