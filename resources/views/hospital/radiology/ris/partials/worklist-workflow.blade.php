...
@if(!empty($completedOnly))
    <a href="{{ route('hospital.radiology.ris.completed-pdf', $row) }}" class="rad-ris-btn rad-ris-btn-outline rad-ris-btn-sm" target="_blank" rel="noopener">
...
@else
    ...
    @elseif($s === 'examination')
        <button type="button" class="rad-ris-btn rad-ris-btn-outline rad-ris-btn-sm rad-ris-wf-open-reporting" data-item-id="{{ $row->id }}"
            ...
            <i class="fa-solid fa-file-waveform"></i> Report in tab
        </button>
    @else
