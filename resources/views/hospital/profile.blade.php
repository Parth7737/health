...
@section('page_subtitle', 'Manage User Profile')
@section('content')
              ...
              <div class="user-image">
                <div class="avatar">
                  <div class="common-align">
                    <div><img id="output" src="{{ auth()->user()->profile_image }}" alt="Profile Image">
                    ...
                    @if(auth()->user()->getRoleNames()->first() == 'Admin')
                      <div class="tab-pane fade show active" id="profiles-project" role="tabpanel" aria-labelledby="profiles-project-tab">
                          ...
                          <div class="card">
                              ...
                              <div class="card-body">
                                  <form method="POST" id="changepassword" class="mt-3" enctype="multipart/form-data">
                                      <div class="form-group mt-3">
