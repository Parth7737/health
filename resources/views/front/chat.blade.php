                    ...
                    <div class="tab-content" id="chat-options-tabContent">
                      <div class="tab-pane fade show active" id="chats" role="tabpanel" aria-labelledby="chats-tab">
                        ...
                        <ul class="chats-user">
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/dashboard-11/user/10.jpg') }}" alt="user">
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/avtar/7.jpg') }}" alt="user">
                                <div class="status bg-success"></div>
                              </div>
                              <div> <span>Jane</span>
                                <p>Hey, What's up?</p>
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/avtar/16.jpg') }}" alt="user">
                                <div class="status bg-success"></div>
                              </div>
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/comment.jpg') }}" alt="user">
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/4.jpg') }}" alt="user">
                                <div class="status bg-success"></div>
                              </div>
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/12.png') }}" alt="user">
                                <div class="status bg-warning"></div>
                              </div>
                              <div> <span>Floyd</span>
                                <p>Are you sure?</p>
                          ...
                          <li class="common-space">
                            <div class="chat-time">
                              <div class="active-profile"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/9.jpg') }}" alt="user">
                                <div class="status bg-warning"></div>
                              </div>
                      ...
                      <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                        ...
                        <div class="contact-wrapper">
                          ...
                          <ul class="border-0">
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/comment.jpg') }}" alt="user">
                              ...
                              <div class="contact-edit">
                                <svg class="dropdown-toggle" role="menu" data-bs-toggle="dropdown" aria-expanded="false">
                                  <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#menubar') }}"></use>
                                </svg>
                          ...
                          <ul class="border-0">
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/blog/12.png') }}" alt="user">
                            ...
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/user/3.png') }}" alt="user">
                            ...
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/user/6.jpg') }}" alt="user">
                          ...
                          <ul class="border-0">
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/user/1.jpg') }}" alt="user">
                          ...
                          <ul class="border-0">
                            <li class="common-space">
                              <div class="chat-time"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/user/2.jpg') }}" alt="user">
                  ...
                  <div class="right-sidebar-title">
                    <div class="common-space">
                      <div class="chat-time-chat">
                        <div class="active-profile-chat"><img class="img-fluid rounded-circle" src="{{ asset('public/front/assets/images/dashboard-11/user/10.jpg') }}" alt="user">
                          <div class="status bg-success"></div>
                        </div>
                      ...
                      <div class="d-flex gap-2 offcanvas-wrapper">
                        <div class="contact-edit chat-alert">
                          <svg>
                            <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#spam') }}"></use>
                          </svg>
                        </div>
                        <div class="contact-edit chat-alert">
                          <svg class="dropdown-toggle" role="menu" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <div class="msger-chat">
                        <div class="msg left-msg">
                          ...
                          <div class="msg-bubble">
                            ...
                            <div class="msg-text">Good morning. How may I help you with this? &#x1F604;</div>
                          </div>
                        </div>
                        <div class="msg right-msg">
                          ...
                          <div class="msg-bubble">
                            ...
                            <div class="msg-text">Could you perhaps clarify the most recent project deadline?</div>
                          </div>
                        </div>
                        <div class="msg right-msg">
                          <div class="msg-img"></div>
                          <div class="msg-bubble">
                            ...
                            <div class="msg-text">Yes, the deadline is scheduled for Friday of next week.</div>
                          </div>
                        </div>
                        <div class="msg left-msg">
                          <div class="msg-img"></div>
                        ...
                        <div class="msg left-msg">
                          ...
                          <div class="msg-bubble">
                            ...
                            <div class="msg-text">I appreciate your quick attention to this.</div>
                          </div>
                        </div>
                        <div class="msg right-msg">
                          <div class="msg-img"></div>
                          <div class="msg-bubble">
                            ...
                            <div class="msg-text">Regards. Do you have any further questions?</div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="dropdown-form dropdown-toggle" role="main" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-plus"></i>
                          <div class="chat-icon dropdown-menu dropdown-menu-start">
                            <div class="dropdown-item mb-2">
                              <svg>
                                <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#camera') }}"></use>
                              </svg>
                            </div>
                            <div class="dropdown-item">
                              <svg>
                                <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#attchment') }}"></use>
                              </svg>
                            </div>
                          </div>
                        </div>
