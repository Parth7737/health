...
@section('title','TP Investigations')
@section('content')
<div class="container-fluid">
  <div class="page-title">
    <div class="row">
      <div class="col-sm-4">
        <h3 class="mb-3 mb-md-0">Treatment plan — investigations</h3>
      </div>
      <div class="col-sm-8 d-flex flex-wrap justify-content-md-end align-items-center gap-2">
        <button class="btn btn-info adddata" data-id="">+ Add investigation</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="dt-ext table-responsive custom-scrollbar html-expert-table">
          <table id="xin-table" class="display table-striped">
            <thead class="table-light">
                <tr><th>#</th><th>Name</th><th>Code</th><th>Scheme type</th><th>Type</th><th>Required</th><th>Action</th></tr>
            </thead>
            <tbody></tbody>
        </table>
      </div>
