<div class="modal-header bg-primary ">
    <h5 class="modal-title text-white" id="view_modal_dataModelLabel">Add/Edit Permission</h5>
        ...
        <div class="col-md-12">
            ...
            <select name="module" class="form-control select2" id="module">
                @foreach($modules as $module)
                    <option value="{{ $module->id }}" {{ @$permission->module == $module->id ? 'selected' : '' }}>{{ $module->name }}</option>
                @endforeach
            </select>
        </div>        
    </div>
