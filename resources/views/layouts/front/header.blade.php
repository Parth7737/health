...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="logo-wrapper"><a href="{{ route('new-dashboard') }}"><img class="img-fluid for-light" src="{{asset('public/front/assets/images/logo/logo.png') }}" alt=""><img class="img-fluid for-dark" src="{{asset('public/front/assets/images/logo/logo_dark.png')}}" alt=""></a></div>
        <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
        </div>
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="logo-header">
              <a href="index.html">
                <img class="img-fluid" src="{{asset('public/front/assets/images/logo/logo.png') }}" height="50" alt="Paracare Logo">
              </a>
            </div>
        </div>
        ...
        <ul class="nav-menus">
            ...
            <li class="fullscreen-body" data-bs-toggle="tooltip" title="Full Screen" data-bs-placement="bottom">                       <span>
                <svg id="maximize-screen">
                <use href="{{asset('public/front/assets/svg/icon-sprite.svg#full-screen')}}"></use>
                </svg></span></li>
            <li data-bs-toggle="tooltip" title="Search" data-bs-placement="bottom">                         <span class="header-search">
                <svg>
                <use href="{{asset('public/front/assets/svg/icon-sprite.svg#search')}}"></use>
                </svg></span></li>
            <!-- <li class="onhover-dropdown">
            <svg>
                <use href="{{asset('public/front/assets/svg/icon-sprite.svg#star')}}"></use>
            </svg>
            ...
            <li data-bs-toggle="tooltip" title="Dark/Light" data-bs-placement="bottom">
            <div class="mode">
                <svg>
                <use href="{{asset('public/front/assets/svg/icon-sprite.svg#moon')}}"></use>
                </svg>
            </div>
            </li>
            ...
            <div class="cart-dropdown onhover-show-div">
                ...
                <ul>
                <li>
                    <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{asset('public/front/assets/images/other-images/cart-img.jpg')}}" alt="">
                ...
                <li>
                    <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{asset('public/front/assets/images/other-images/cart-img1.jpg')}}" alt="">
            ...
            <div class="notification-box">
                <svg>
                <use href="{{asset('public/front/assets/svg/icon-sprite.svg#notification')}}"></use>
            ...
            <div class="onhover-show-div notification-dropdown">
             ...
             <!-- IPD Bed Status & OT Status Icons Start -->
             <li data-bs-toggle="tooltip" title="IPD Bed Status" data-bs-placement="bottom">
                <a href="#bedStatusModal" data-bs-toggle="modal"  >
                    <svg width="24" height="24">
                        <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#stroke-layout') }}"></use>
                    </svg>
                </a>
            </li>
            <li data-bs-placement="bottom" data-bs-toggle="tooltip" title="OT Status">
                <a href="#otStatusModal" data-bs-toggle="modal"  >
                    <svg width="24" height="24">
                        <use href="{{ asset('public/front/assets/svg/icon-sprite.svg#stroke-widget') }}"></use>
                    </svg>
                </a>
            </li>
            <!-- IPD Bed Status & OT Status Icons End -->
            <li class="profile-nav onhover-dropdown pe-0 py-0">
            <div class="d-flex profile-media"><img class="b-r-10" src="{{asset('public/front/assets/images/dashboard/profile.png')}}" alt="">
