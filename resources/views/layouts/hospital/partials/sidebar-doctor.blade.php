...
<nav class="gov-sidebar hims-sidebar">
    ...
    <ul class="gov-sidebar-links sidebar-nav" id="hospitalGovSidebarMenu">
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title {{ request()->routeIs('hospital.doctor-dashboard') ? 'active' : '' }}" href="{{ route('hospital.doctor-dashboard') }}">
        ...
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title {{ request()->routeIs('hospital.pathology.worklist.*') ? 'active' : '' }}" href="{{ route('hospital.pathology.worklist.index') }}">
                <span class="nav-icon">🧪</span>
                <span class="nav-label">Lab Orders / Results</span>
            </a>
        </li>
        ...
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title {{ request()->is('hospital/pharmacy/*') ? 'active' : '' }}" href="{{ route('hospital.pharmacy.sale.index') }}">
                <span class="nav-icon">💊</span>
                <span class="nav-label">e-Prescriptions</span>
            </a>
        </li>
        ...
        <li class="sidebar-list">
            <a class="sidebar-link sidebar-title" href="{{ route('hospital.dashboard') }}">
                <span class="nav-icon">📝</span>
                <span class="nav-label">Clinical Templates</span>
            </a>
        </li>
