...
use App\Http\Controllers\{ RegisterController, HomeController, CaptchaController, LoginController };
...
//     \Artisan::call('db:seed QualityAuditSeeder');    
//     return true;
// });
...
})->middleware(['auth','superadmin', 'verified'])->name('dashboard');
...
Route::post('hospital/sendAadhaarMail', [RegisterController::class, 'sendAadhaarMail'])->name('hospital.sendAadhaarMail');

Route::get('/captcha-image', [CaptchaController::class, 'generateCaptcha'])->name('generateCaptcha');
Route::post('/verify-captcha', [CaptchaController::class, 'verifyCaptcha'])->name('verifyCaptcha');
Route::post('register/sendAadhaarMail', [RegisterController::class, 'sendAadhaarMail'])->name('sendAadhaarMail');
...
Route::post('getbankdetails', [HomeController::class, 'getBankData'])->name('getbankdetails');
Route::post('getaccountdetails', [HomeController::class, 'getaccountdetails'])->name('getaccountdetails');
Route::post('getGstDetails', [HomeController::class, 'getGstDetails'])->name('getGstDetails');
Route::get('download-case-report/{status}/{extracondition}/{conditions?}', [HomeController::class, 'downloadCaseReport'])->name('getDownloadReport');
...
require __DIR__.'/preauth.php';

require __DIR__.'/dec.php';

require __DIR__.'/verifier.php';

require __DIR__.'/ppd.php';

require __DIR__.'/cpd.php';

require __DIR__.'/sec.php';

require __DIR__.'/cex.php';

require __DIR__.'/aco.php';

require __DIR__.'/sha.php';

require __DIR__.'/shaadmin.php';

require __DIR__.'/medical-committee.php';

require __DIR__.'/ceo.php';

require __DIR__.'/acschairman.php';

Route::post('notifications', [HomeController::class, 'getNotifications'])->name('getNotifications');
Route::post('markasRead', [HomeController::class, 'markasRead'])->name('markasRead');

if (App::environment('development')) {     URL::forceScheme('https'); }
