    ...
    <div class="col-md-6 col-lg-4">
        <div class="ditel-card p-3" data-bs-toggle="modal" data-bs-target="#bigModal">
            ...
            <p class="mb-2">Register ID: <strong>{{ $user->register_id }}</strong></p>
                    ...
                    <p class="mb-2">Claim Submission Date:<strong>{{ date("d/m/Y",strtotime($user->claim_submited_date)) }}</strong></p>
            <div class="balance-card p-2">
                ...
                <div class="icons d-flex">
                    ...
                    <a href="{{ route('cpd.preauth-request',[$user->id]) }}" class="angle-right">
