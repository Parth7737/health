...
@php
    ...
    $helpers = new Helpers();
    $medicalinfo = $helpers->checkStepSeen($preauth_register->id, 'Medical_Information', 'CPD');
    $admissioninfo = $helpers->checkStepSeen($preauth_register->id, 'Admission_Informations', 'CPD');
    $treatmentinfo = $helpers->checkStepSeen($preauth_register->id, 'Treatment', 'CPD');
    $documentsinfo = $helpers->checkDocStepSeen($preauth_register->id, 'cpd_status');
    $financeinfo = $helpers->checkStepSeen($preauth_register->id, 'Finance', 'CPD');
    ...
    $expireDocsMsg = \App\CentralLogics\Helpers::expiredDocs($preauth_register->id);
@endphp
    ...
    <div class="row">
        <div class="bs-stepper-content">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
                @include('cpd._partials.preauth-step')
                <div class="bs-stepper-content">
                    <!-- Account Details -->
                    ...
                    <div id="personal-info" class="content active">
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @include('cpd._partials.past-preauth')
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('cpd._partials.diagnosis')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('cpd._partials.procedures')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                ...
                                <div id="accordionPopoutFive"
                                    ...
                                    <div class="accordion-body">
                                        <div class="inside-left-info-box {{ $preauth_investigation_status?'success':'pending' }} mt-3">
                                            ...
                                            <div class="row justify-content-center">                                               
                                                @include('cpd._partials.investigations',['preauth_register_id'=>$preauth_register->id])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="accordionPopoutFour"
                                    ...
                                    <div class="accordion-body">
                                                ...
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0 finance-body">
                                                            @include('cpd._partials.finance')
                                                        </tbody>
                                                    </table>
                                                </div>
                                                @if($preauth_register->status != PreauthRegister::STATUS_CPD_CLAIM_PENDING && $preauth_register->status != PreauthRegister::STATUS_ACO_CLAIM_QUERIED && $preauth_register->status != PreauthRegister::STATUS_SHA_CLAIM_QUERIED)
                                                    <ul class="d-flex listing-right finance-total-body">
                                                        @include('cpd._partials.finance-total')
                                                    </ul>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="approve-form d-none">
                                                <form onSubmit="return false" id="approveRejectPreauthForm">
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody class="table-border-bottom-0 finance-body">
                                                                        ...
                                                                        @php $sub_total = @$procedure->procedure_price+@$procedure->incentive+@$procedure->stratification_price-@$procedure->deducted_amount @endphp
                                                                            @if($procedure->preauth_status != "Rejected")
                                                                                <tr>
                                                                                    <td>{{ $i++ }}</td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="deduction-{{ $key }}">
                                                                                            @if(@$procedure->deducted_amount != 0)
                                                                                                <span class="text-success" onclick="deductionAmount('{{ $procedure->id }}','deduction-{{ $key }}')">Yes</span>
                                                                                            @else
                                                                                                <span class="text-danger" onclick="deductionAmount('{{ $procedure->id }}','deduction-{{ $key }}')">No</span>
                                                                                            @endif
                                                                                        </div>
                                                                                    </td>
                                                                                    <td class="deduction-total">₹{{ number_format(@$procedure->deducted_amount,2) }}</td>
                                                                                    <td class="amount-total">₹{{ number_format(@$sub_total, 2) }}</td>
                                                                                    <td>
                                                                                        <select name="procedure_status[{{ $procedure->id }}]" id="procedure-status-{{ $procedure->id }}" data-type="procedure" data-procedureid="{{@$procedure->id}}" data-implantid="{{$procedure->implant_id}}" class="select2 procedure-status form-select form-select-lg">
                                                                                ...
                                                                                @if($procedure->implant_id && ($procedure->preauth_implant_status != "Rejected" || @$procedure->preauth_status == "Rejected"))
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="reason-section" id="implant-reason-status-{{ $procedure->id }}">
                                                                                                Not Applicable
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                            <div class="remarks-section" id="remark-section-{{ $procedure->id }}">
                                                                                                Not Applicable
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                    ...
                                                    <div class="documentdetails">
                                                        @include('cpd._partials.documentdetails', ['preauth_register' => $preauth_register])
                                                    </div>
                                                    <table class="table">
                                                        <thead class="table-white">
                                                            <tr class="border border-primary">
                                                                <th class="text-primary p-3" style="width: 50%;">Diagnosis is supported by evidence:
                                                                    <input type="hidden" name="diagnosis_support_evidence_name" value="Diagnosis is supported by evidence">
                                                                </th>
                                                                <th class="float-left p-3">
                                                                    <div class="d-flex errormesage">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="diagnosis_support_evidence" id="diagnosis_support_evidence" value="Y" checked>
                                                                            <label class="form-check-label" for="diagnosis_support_evidence">
                                                                                Yes
                                                                            </label>
                                                                        </div>
                                                                        <div class="form-check ms-4">
                                                                            <input class="form-check-input" type="radio" name="diagnosis_support_evidence" id="diagnosis_support_evidence2" value="N" >
                                                                            <label class="form-check-label" for="diagnosis_support_evidence2">
                                                                                No
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <th class="float-left p-3 ">
                                                                    <div class="diagnosis_support_evidence d-none diagnosis_support_evidence_procedure_id">
                                                                        <select name="diagnosis_support_evidence_procedure_id[]" id="diagnosis_support_evidence_procedure_id" class="select2 form-select form-select-lg aerrormesage" multiple data-allow-clear="true">
                                                                            @foreach(@$procedures as $procedure)
                                                                                <option value="{{$procedure->id}}" >{{@$procedure->procedure->procedure_code_2}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </th>
                                                            ...
                                                            <tr class="border border-primary">
                                                                <th class="text-primary p-3" style="width: 50%;">Case Management as per the Standard Treatment Guidlines(STG):
                                                                <input type="hidden" name="case_as_per_stg_name" value="Case Management as per the Standard Treatment Guidlines(STG)">
                                                                </th>
                                                                <th class="float-left p-3">
                                                                    <div class="d-flex errormesage">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="case_as_per_stg" id="case_as_per_stg" value="Y" checked>
                                                                            <label class="form-check-label" for="case_as_per_stg">
                                                                                Yes
                                                                            </label>
                                                                        </div>
                                                                        <div class="form-check ms-4">
                                                                            <input class="form-check-input" type="radio" name="case_as_per_stg" id="case_as_per_stg2" value="N" >
                                                                            <label class="form-check-label" for="case_as_per_stg2">
                                                                                No
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <th class="float-left p-3 ">
                                                                    <div class="case_as_per_stg case_as_per_stg_procedure_id d-none">
                                                                        <select name="case_as_per_stg_procedure_id[]" id="case_as_per_stg_procedure_id" class="select2 form-select form-select-lg aerrormesage" multiple data-allow-clear="true">
                                                                            @foreach(@$procedures as $procedure)
                                                                                <option value="{{$procedure->id}}" >{{@$procedure->procedure->procedure_code_2}}</option>
                                                                            @endforeach
                                                                        </select>
                                                            ...
                                                            <tr class="border border-primary">
                                                                <th class="text-primary p-3" style="width: 50%;">Weather Duration of treatment matched with STG instead of treatment protocol:
                                                                <input type="hidden" name="weather_duration_treatment_name" value="Weather Duration of treatment matched with STG instead of treatment protocol)">

                                                                </th>
                                                                <th class="float-left p-3">
                                                                    <div class="d-flex errormesage">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="weather_duration_treatment" id="weather_duration_treatment" value="Y" checked>
                                                                            <label class="form-check-label" for="weather_duration_treatment">
                                                                                Yes
                                                                            </label>
                                                                        </div>
                                                                        <div class="form-check ms-4">
                                                                            <input class="form-check-input" type="radio" name="weather_duration_treatment" id="weather_duration_treatment2" value="N" >
                                                                            <label class="form-check-label" for="weather_duration_treatment2">
                                                                                No
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <th class="float-left p-3 " >
                                                                    <div class="weather_duration_treatment selecterror weather_duration_treatment_procedure_id d-none">
                                                                        <select name="weather_duration_treatment_procedure_id[]" id="weather_duration_treatment_procedure_id" class="select2 form-select form-select-lg aerrormesage" multiple data-allow-clear="true">
                                                                            @foreach(@$procedures as $procedure)
                                                                                <option value="{{$procedure->id}}" >{{@$procedure->procedure->procedure_code_2}}</option>
                                                                            @endforeach
                                                                        </select>
                                                    ...
                                                    @if($preauth_register->aco_remark && $preauth_register->status == PreauthRegister::STATUS_ACO_CLAIM_QUERIED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->aco_remark}}</textarea>
                                                                <label for="remarks">Queried By ACO</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if($preauth_register->sha_remark && $preauth_register->status == PreauthRegister::STATUS_SHA_CLAIM_QUERIED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->sha_remark}}</textarea>
                                                                <label for="remarks">Queried By SHA</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="row ">
                                        ...
                                        @if($preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_CLAIM_PENDING || $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_ACO_CLAIM_QUERIED || $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_SHA_CLAIM_QUERIED)
                                            <div class="erroneous-form d-none">
                                                <form onSubmit="return false" id="approveRejectErroneousClaimForm">
                                                    ...
                                                    <div class="col-md-3 pt-7 erroneous-approve-field d-none">
                                                        <div
                                                            class="form-floating form-floating-outline">
                                                            <input type="number" name="erroneous_appoved_amount" id="erroneous_appoved_amount" value="{{ $preauth_register->erroneous_raise_amount }}" max="{{ $preauth_register->erroneous_raise_amount }}" class="form-control" />
                                                            <label for="erroneous_appoved_amount">Approve Amount</label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 pt-7">
                                                        <div
                                                            class="form-floating form-floating-outline">
                                                            <input type="number" disabled value="{{ $preauth_register->erroneous_raise_amount }}"
                                                                class="form-control" />
                                                            <label for="erroneous_raise_amount">Erroneous Raise Amount</label>
                                                        </div>
                                                    </div>
                                                    @if($preauth_register->erroneous_raise_remarks && $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_CLAIM_PENDING)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-success" disabled >{{$preauth_register->erroneous_raise_remarks}}</textarea>
                                                                <label for="remarks">Erroneous Remarks by Medco</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if($preauth_register->erroneous_aco_remarks && $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_ACO_CLAIM_QUERIED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->erroneous_aco_remarks}}</textarea>
                                                                <label for="remarks">Erroneous Remarks by ACO</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @if($preauth_register->erroneous_sha_remarks && $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_SHA_CLAIM_QUERIED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->erroneous_sha_remarks}}</textarea>
                                                                <label for="remarks">Erroneous Remarks by SHA</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="row ">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            @if($preauth_register->status == PreauthRegister::STATUS_CPD_CLAIM_PENDING)
                                <button type="button" class="btn btn-primary ms-2 action-btn" onclick="approvePreauth()">Submit Claim</button>
                            @endif

                            @if($preauth_register->status == PreauthRegister::STATUS_ACO_CLAIM_QUERIED || $preauth_register->status == PreauthRegister::STATUS_SHA_CLAIM_QUERIED)
                            <button type="button" class="btn btn-primary ms-2 action-btn" onclick="approvePreauth()">Show Query Response</button>
                            @endif
                            @if($preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_CLAIM_PENDING || $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_ACO_CLAIM_QUERIED || $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_SHA_CLAIM_QUERIED)
                                <button type="button" class="btn btn-primary ms-2 action-btn" onclick="erroneousClaimAction()">Action</button>
                            @endif
                        </div>
                    </div>
                    <!-- Social Links -->
...
<div class="modal fade" id="deductionModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title mb-4 text-white" id="deductionModalLabel3">Add Deduction</h4>
                <button type="button" class="btn-close mb-4 text-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body p-0">
                <div class="card">
                    <form onSubmit="return false" id="deductionForm">
                        <div class="card-body">
                            <div class="row">
                                @php $reasons = App\CentralLogics\Helpers::getCommanData('DeductionReason'); @endphp
                                <!-- <div class="col-md-4 mb-4">
                                    <div
                                        class="form-floating form-floating-outline">
                                        <select class="form-select select2" id="deduction_reason"
                                            name="deduction_reason">
                                            <option value=""></option>
                                            @foreach($reasons as $reason)
                                                <option value="{{ $reason->name }}">{{ $diabetes->name }}</option>
                                            @endforeach
                                        </select>
                                        <label for="deduction_reason">Deduction Type</label>
                                    </div>
                                </div> -->
                                <div class="col-md-4 mt-2">
                                    <input type="hidden" name="deduction_procedure_id" id="deduction_procedure_id">
                                    <div class="form-floating form-floating-outline mb-6">
                                        <input class="form-control" type="number" id="deduct_amount" name="deduct_amount" >
                                        <label for="deduct_amount">Amount<span class="text-danger">*</span></label>
                                    </div>
                                    <div id="deduction-amount-error"></div>
                                </div>
                                <div class="col-md-4 mt-2">
                                    <div class="form-floating form-floating-outline mb-6">
                                        <textarea class="form-control" id="deduction_remarks" name="remarks" ></textarea>
                                        <label for="remarks" class="deduction-remark-title">Remarks<span class="text-danger">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-end">
                                        <button id="deduction-btn"
...
<script>
    ...
    $(document).ready(function () {
        $('input[name="diagnosis_support_evidence"]').on('click', function () {
            var selectedValue = $('input[name="diagnosis_support_evidence"]:checked').val();
            
            if (selectedValue === 'Y') {
                $('#diagnosis_support_evidence_procedure_id').prop('required', false);
                $('.diagnosis_support_evidence').addClass('d-none');
            } else {
                $('#diagnosis_support_evidence_procedure_id').prop('required', true);
                $('.diagnosis_support_evidence').removeClass('d-none');
            }
        });

        $('input[name="case_as_per_stg"]').on('click', function () {
            var selectedValue = $('input[name="case_as_per_stg"]:checked').val();
            
            if (selectedValue === 'Y') {
                $('#case_as_per_stg_procedure_id').prop('required', false);
                $('.case_as_per_stg').addClass('d-none');
            } else {
                $('#case_as_per_stg_procedure_id').prop('required', true);
                $('.case_as_per_stg').removeClass('d-none');
            }
        });

        $('input[name="weather_duration_treatment"]').on('click', function () {
            var selectedValue = $('input[name="weather_duration_treatment"]:checked').val();
            
            if (selectedValue === 'Y') {
                $('#weather_duration_treatment_procedure_id').prop('required', false);
                $('.weather_duration_treatment').addClass('d-none');
            } else {
                $('#weather_duration_treatment_procedure_id').prop('required', true);
                $('.weather_duration_treatment').removeClass('d-none');
            }
        });
    });
    ...
    function erroneousClaimAction(){
        if($("#accordionPopoutFour.show").length == 0){
            $('button[data-bs-target="#accordionPopoutFour"]').trigger("click");
        }
        $(".erroneous-form").removeClass('d-none');
        $(".action-btn").addClass("d-none");
    }
    ...
    $("#approve-preauth-btn").on("click",function(){
        ...
        swal({
            ...
            if (willDelete) {
                ...
                $('.error').remove();
                $.ajax({
                    url: '{{route("cpd.submit-preauth-claim")}}',
                    headers: {
                    ...
                    success: function (response) {
                        ...
                        if(response.success){
                            ...
                            setTimeout(() => {
                                window.location.href="{{ route('cpd.dashboard') }}";
                            }, 1000);
                        }else{
    ...
    $("#erroneous-claim-btn").on("click",function(){
        ...
        swal({
            ...
            if (willDelete) {
                ...
                $('.error').remove();
                $.ajax({
                    url: '{{route("cpd.erroneous-claim-action")}}',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
                    type: 'POST',
    ...
    $(".procedure-status").on("change",function(){
        ...
        var status = $(this).val();
        var implantid = $(this).data('implantid');
        ...
        if(status == 'Approved'){
            ...
            @php $reasons = \App\Models\PreauthClaimReason::where('type', 'Reject')->get(); @endphp
            ...
            if(implantid) {
                $('#implant-status-'+procedureid).val('Rejected').trigger('change');
            }
        }else if(status == 'Query'){
            @php $reasons = \App\Models\PreauthClaimReason::where('type', 'Query')->get(); @endphp
            $(this).parent().parent().find('.reason-section').html(`
                <select name="`+field_name+`" id="${type}-reason-`+id+`" data-type="${type}" data-procedureid="${procedureid}" class="select2 form-select form-select-lg procedure-reason">
                    <option value="">Select</option>
                    @foreach($reasons as $reason)
    ...
    function openRemarkModal(id,type) {
        $(".loader-overlay").show();
        $.ajax({
            url: '{{route("cpd.loadremark", [$preauth_register->id])}}', 
            type: 'POST',
            data: {
                '_token': '{{csrf_token()}}',
                'id' : id,
    ...
    $('.sendRemark').on('click', function() {
        ...
        if(remark) {
            ...
            $.ajax({
                url: '{{route("cpd.addRemark", [$preauth_register->id])}}',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                },
                type: 'POST',
    ...
    var active_deduction_class ="";
    function deductionAmount(procedure_id,active_deduction){
        active_deduction_class = active_deduction;
        $(".loader-overlay").show();
        $.ajax({
            url: '{{route("cpd.get-deduction")}}',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            type: 'POST',
            ...
            success: function (response) {
                ...
                if(response.success){
                    ...
                    $("#deduct_amount").attr("max-length",response.max);
                    if(response.deducted_amount != ''){
                        $("#deduct_amount").val(response.deducted_amount);
                        $("#deduction_remarks").val(response.deduction_remarks);
                        $("#deduction-btn").attr('disabled',false);
                    }
                    $("#deduction_procedure_id").val(procedure_id);
                }else{
                    errorMessage(response.message);
                }
            },
    ...
    $("#deduction-btn").on("click",function(){
        
        var formData = new FormData($('#deductionForm')[0]);
        
        $(".loader-overlay").show();
        $('.error').remove();
        $.ajax({
            url: '{{route("cpd.save-deduction")}}',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            type: 'POST',
            ...
            success: function (response) {
                ...
                if(response.success){
                    ...
                    eventfn = $('.'+active_deduction_class).find("span").attr("onclick");
                    if(response.deducted_amount > 0){
                        $('.'+active_deduction_class).html(`<span class="text-success" onclick="`+eventfn+`">Yes</span>`);
                    }else{
                        $('.'+active_deduction_class).html(`<span class="text-danger" onclick="`+eventfn+`">No</span>`);
                    }
                    $('.'+active_deduction_class).parent().parent().find('.amount-total').html(response.total_amount);
                    $('.'+active_deduction_class).parent().parent().find('.deduction-total').html(response.deducted_amount_format);
                    calculateTotal();
                }else{
                    errorMessage(response.message);
                }
    ...
    $("#deduct_amount").on("input", function () {
        let amount = $(this).val();
        if(amount == 0){
            $(".deduction-remark-title").html(`Remarks<span class="text-danger"></span>`);
        }else{
            $(".deduction-remark-title").html(`Remarks<span class="text-danger">*</span>`);
        }
        let max = parseInt($(this).attr("max-length"));
        if (!isNaN(amount) && !isNaN(max) && amount > max) {
            $("#deduction-amount-error").html("<span class='text-danger'>You cannot deduct more than " + max + " amount.</span>");
            $("#deduction-btn").attr('disabled',true);
        } else {
            $("#deduction-amount-error").html("");
            if(amount != ''){
                $("#deduction-btn").attr('disabled',false);
            }else{
                $("#deduction-btn").attr('disabled',true);
    ...
    $("#erroneous_status").on("change",function(){
        if($(this).val() == 'Approve'){
            $(".erroneous-approve-field").removeClass("d-none");
        }else{
            $(".erroneous-approve-field").addClass("d-none");
            $("#erroneous-claim-btn").attr('disabled',false);
        }
    })
    $("#erroneous_appoved_amount").on("input", function () {
        let amount = $(this).val();
        let max =parseFloat($(this).attr("max"));

        if (!isNaN(amount) && !isNaN(max) && amount > max) {
            $("#erroneous-approve-amount-error").html("<span class='text-danger'>Approve Amount cannot be more than "+max+" Raise Amount.</span>");
            $("#erroneous-claim-btn").attr('disabled',true);
        } else {
            $("#erroneous-approve-amount-error").html("");
            if(amount != ''){
                $("#erroneous-claim-btn").attr('disabled',false);
            }else{
                $("#erroneous-claim-btn").attr('disabled',true);
