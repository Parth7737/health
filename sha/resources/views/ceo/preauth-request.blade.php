...
@php
    ...
    $helpers = new Helpers();
    $medicalinfo = $helpers->checkStepSeen($preauth_register->id, 'Medical_Information', 'CEO');
    $admissioninfo = $helpers->checkStepSeen($preauth_register->id, 'Admission_Informations', 'CEO');
    $treatmentinfo = $helpers->checkStepSeen($preauth_register->id, 'Treatment', 'CEO');
    $documentsinfo = $helpers->checkDocStepSeen($preauth_register->id, 'ceo_status');
    $financeinfo = $helpers->checkStepSeen($preauth_register->id, 'Finance', 'CEO');
@endphp
    ...
    <div class="row">
        <div class="bs-stepper-content">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
                @include('ceo._partials.preauth-step')
                <div class="bs-stepper-content">
                    <!-- Account Details -->
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @include('ceo._partials.past-preauth')
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('ceo._partials.diagnosis')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('ceo._partials.procedures')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                ...
                                <div id="accordionPopoutFive"
                                    ...
                                    <div class="accordion-body">
                                        <div class="inside-left-info-box mt-3">
                                            ...
                                            <div class="row justify-content-center">                                               
                                                @include('ceo._partials.investigations',['preauth_register_id'=>$preauth_register->id])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0 finance-body">
                                                            @include('ceo._partials.finance')
                                                        </tbody>
                                                    </table>
                                                </div>
                                                <ul class="d-flex listing-right finance-total-body">
                                                    @include('ceo._partials.finance-total')
                                                </ul>
                                            </div>
                                        </div>
                                        @if($preauth_register->status == PreauthRegister::STATUS_MEDICAL_COMMITTEE_APPROVED)
                                            <div class="action-form d-none mt-3">
                                                <form onSubmit="return false" id="approveRejectPreauthForm">
                                                    ...
                                                    <div class="col-md-3 pt-7 ceo-approve-field d-none">
                                                        <div
                                                            class="form-floating form-floating-outline">
                                                            <input type="number" name="approved_amount" id="approved_amount" value="{{ $preauth_register->committee_approved_amount }}" max="{{ $preauth_register->preauth_initiated_amount }}" class="form-control" />
                                                            <label for="approved_amount">Approve Amount</label>
                                                        </div>
                                                        <div id="approved-amount-error"></div>
                                                    </div>
                                                    <div class="col-md-12 mt-2">
                                                        <div class="form-floating form-floating-outline mb-6 ceoerror">
                                                    ...
                                                    @if($preauth_register->ceo_query_response_remarks && $preauth_register->status == PreauthRegister::STATUS_MEDICAL_COMMITTEE_APPROVED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->ceo_query_response_remarks}}</textarea>
...
<script>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success){
                            ...
                            setTimeout(() => {
                                window.location.href="{{ route('ceo.dashboard') }}";
                            }, 1000);
                        }else{
    ...
    $("#preauth_status").on("change",function(){
        if($(this).val() == 'Approve'){
            $(".ceo-approve-field").removeClass("d-none");
        }else{
            $(".ceo-approve-field").addClass("d-none");
    ...
    $("#approved_amount").on("input", function () {
        ...
        if (!isNaN(amount) && !isNaN(max) && amount > max) {
            $("#approved-amount-error").html("<span class='text-danger'>Approve Amount cannot be more than "+max+" Raise Amount.</span>");
            $("#preauth-btn").attr('disabled',true);
        } else {
            $("#approved-amount-error").html("");
            if(amount != ''){
                $("#preauth-btn").attr('disabled',false);
            }else{
                $("#preauth-btn").attr('disabled',true);
