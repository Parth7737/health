...
@php 
    ...
    if($is_apply){
        ...
        if(($procedure->implant_id && (($procedure->preauth_implant_status == 'Approved' && $procedure->preauth_claim_implant_status == '') || in_array($procedure->preauth_register->status,$status_arr))) || ($procedure->implant_id && $procedure->preauth_claim_implant_status == 'Approved')){
