            ...
            <div
                ...
                <table class="table">
                    ...
                    <tbody
                        ...
                        @include('_partials.diagnosis', ['preauth_diagnosis' => @$preauth_diagnosis,'is_action_hide'=>1])
                    </tbody>
                </table>
            </div>
        </div>
            ...
            <div
                ...
                <table class="table">
                    ...
                    <tbody
                        ...
                        @include('_partials.procedures', ['procedures' => @$procedures,'is_action_hide'=>1])
                    </tbody>
                </table>
            </div>
        </div>
            ...
            <div class="table-responsive mt-5 text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0 care-team-body">
                        @include('_partials.teams', ['preauth_teams' => @$preauth_teams,'is_action_hide'=>1])
                    </tbody>
                </table>
            </div>
        </div>
            ...
            <div class="table-responsive mt-5 text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0 finance-body">
                        @include('_partials.finance', ['procedures' => @$procedures])
                    </tbody>
                </table>
            </div>
            <ul class="d-flex listing-right finance-total-body">
                @include('_partials.finance-total', ['procedures' => @$procedures])
            </ul>
        </div>
    </div>
</div>