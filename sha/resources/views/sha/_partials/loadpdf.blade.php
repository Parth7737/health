...
@if($preauth_register->status == \App\Models\PreauthRegister::STATUS_ACO_CLAIM_APPROVED || $preauth_register->status == \App\Models\PreauthRegister::STATUS_ERRONEOUS_ACO_CLAIM_APPROVED)
