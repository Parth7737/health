                        ...
                        <div class="col-md-6 col-lg-3">
                            <div
                                ...
                                <select class="form-select select2" id="status" name="status">
                                    ...
                                    <option value="">Unspecified Surgical Package (U100) Preauthorization Pending</option>
                                    <option value="">Unspecified Surgical Package (U100) Preauthorization Approved</option>
                                    <option value="">Unspecified Surgical Package (U100) Preauthorization Queried To Medco</option>
