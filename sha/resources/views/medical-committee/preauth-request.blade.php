...
@php
    ...
    $helpers = new Helpers();
    $medicalinfo = $helpers->checkStepSeen($preauth_register->id, 'Medical_Information', 'MC');
    $admissioninfo = $helpers->checkStepSeen($preauth_register->id, 'Admission_Informations', 'MC');
    $treatmentinfo = $helpers->checkStepSeen($preauth_register->id, 'Treatment', 'MC');
    $documentsinfo = $helpers->checkDocStepSeen($preauth_register->id, 'medical_committee_status');
    $financeinfo = $helpers->checkStepSeen($preauth_register->id, 'Finance', 'MC');
@endphp
    ...
    <div class="row">
        <div class="bs-stepper-content">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
                @include('medical-committee._partials.preauth-step')
                <div class="bs-stepper-content">
                    <!-- Account Details -->
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @include('medical-committee._partials.past-preauth')
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('medical-committee._partials.diagnosis')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('medical-committee._partials.procedures')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0 care-team-body">
                                                            @include('medical-committee._partials.teams')
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                ...
                                <div id="accordionPopoutFive"
                                    ...
                                    <div class="accordion-body">
                                        <div class="inside-left-info-box mt-3">
                                            ...
                                            <div class="row justify-content-center">                                               
                                                @include('medical-committee._partials.investigations',['preauth_register_id'=>$preauth_register->id])
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="table-responsive mt-5 text-nowrap">
                                                    <table class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0 finance-body">
                                                            @include('medical-committee._partials.finance')
                                                        </tbody>
                                                    </table>
                                                </div>
                                                <ul class="d-flex listing-right finance-total-body">
                                                    @include('medical-committee._partials.finance-total')
                                                </ul>
                                            </div>
                                        </div>
                                        @if($preauth_register->status == PreauthRegister::STATUS_MEDICAL_COMMITTEE_PENDING)
                                                ...
                                                <form onSubmit="return false" id="approveRejectPreauthForm">
                                                    ...
                                                    <div class="col-md-3 pt-7 committee-approve-field d-none">
                                                        <div
                                                            ...
                                                            <input type="number" name="committee_approved_amount" id="committee_approved_amount" value="{{ $preauth_register->preauth_initiated_amount }}" max="{{ $preauth_register->preauth_initiated_amount }}" class="form-control" />
                                                            <label for="committee_approved_amount">Approve Amount</label>
                                                        </div>
                                                    ...
                                                    @if($preauth_register->committee_query_response_remarks && $preauth_register->status == PreauthRegister::STATUS_MEDICAL_COMMITTEE_PENDING)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-danger" disabled >{{$preauth_register->committee_query_response_remarks}}</textarea>
...
<script>
    ...
    $("#preauth-btn").on("click",function(){
        ...
        swal({
            ...
            if (willDelete) {
                ...
                $('.error').remove();
                $.ajax({
                    url: '{{route("medical-committee.approve-preauth")}}',
                    headers: {
                    ...
                    success: function (response) {
                        ...
                        if(response.success){
                            ...
                            setTimeout(() => {
                                window.location.href="{{ route('medical-committee.dashboard') }}";
                            }, 1000);
                        }else{
    ...
    function opentab(tab, id) {
        ...
        $.ajax({
            url: '{{route("medical-committee.open-tabs")}}',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            type: 'POST',
    ...
    $("#committee_approved_amount").on("input", function () {
        let amount = $(this).val();
