            ...
            <div class="col-md-5">
               <div class="d-flex align-items-center bg-theme-color arrow">
                     <ul class="menu-list mb-0 py-2  d-flex">
                        <li class="menu-item">
                           <a href="{{$url}}" class="menu-link bottom-menu-icons">
        ...
        <div class="col-md-12">
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"><i class="ri-user-3-line me-2"></i>Profile</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        ...
                        <li class="d-flex align-items-center mb-4">
                            ...
                            <span>{{@$user->role->name}}@if(@$user->entity_type)({{@$user->entity_type}})@endif</span>
                        </li>
                        @if(@$user->state)
                        <li class="d-flex align-items-center mb-4">
