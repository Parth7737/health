                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 financeerror" id="dec_statussfinance" name="dec_status" required>
                                            <option value="">Select</option>
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 taxationerror" id="dec_statusstaxation" name="dec_status" required>
                                            <option value="">Select</option>
...
$('.savefinancialInfo').on('click', function() {
    ...
    $.ajax({
        url: '{{route("dec.saveFinancialReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
        headers: {
...
$('.savetaxationFormInfo').on('click', function() {
    ...
    $.ajax({
        url: '{{route("dec.saveTaxdetailsReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
        headers: {
            'X-CSRF-TOKEN': '{{ csrf_token() }}'
        },
        type: 'POST',
