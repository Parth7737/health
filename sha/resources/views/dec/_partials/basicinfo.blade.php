                ...
                <form id="establishmentForm">
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 eerror" id="dec_statussestablish" name="dec_status" required>
                                            <option value="">Select</option>
                    ...
                    @if(!$iseditdec)
                        <div class="d-flex justify-content-end mt-3">
                            <button type="button" class="btn mt-2 btn-primary justify-content-end rounded-0 saveestablishmentForm" >Save</button>
                        </div>
                    @endif
                </form>
            </div>
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 aerror" id="dec_statussaddress" name="dec_status" required>
                                            <option value="">Select</option>
...
<script>
    $('.saveestablishmentForm').on('click', function() {
        ...
        $.ajax({
            url: '{{route("dec.saveEstablishmentReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
            headers: {
    ...
    $('.saveaddressForm').on('click', function() {
        ...
        $.ajax({
            url: '{{route("dec.saveAddressReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
            },
            type: 'POST',
