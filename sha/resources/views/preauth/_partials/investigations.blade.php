...
@php $preauth_investigation = App\Models\PreauthInvestigation::where('preauth_register_id',$preauth_register_id)->withoutGlobalScopes()->where('investigation_id',$investigation->id)->first(); @endphp
<tr>
