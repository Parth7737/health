...
@php 
    ...
    $i++;
    if($procedure->preauth_status == 'Approved' || $procedure->preauth_status == 'Forwarded To Medical Committee' || $procedure->preauth_implant_status == 'Approved'){
        $is_apply=1;
    }else{
        $is_apply=0;
    }
    if($is_apply){
        ...
        if($procedure->preauth_implant_status == 'Approved'){
