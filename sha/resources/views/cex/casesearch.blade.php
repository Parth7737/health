    ...
    <div class="row">
        <div class="bs-stepper-content">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('cex.dashboard') }}" class="btn btn-outline-primary">Back</a>
            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div
                                ...
                                <select class="form-select select2" id="status" name="status">
                                    <option value=""></option>
                                    <option value="{{PreauthRegister::STATUS_CLAIM_PENDING}}">Claim Pending</option>
