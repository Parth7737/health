...
@section('title','Dashboard | ACS/Chairman')
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('acschairman.case-search') }}" class="btn btn-outline-primary me-2"><i class="ri-user-search-line"></i> Case Search</a>
                </div>
            </div>
        </div>
        <div class="row g-6">
            <div class="col-sm-6 col-lg-3">
                <div class="card card-border-shadow-warning h-100">
                    <div class="card-body" onclick="getStatusData('{{ PreauthRegister::STATUS_ACS_PENDING }}')">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card card-border-shadow-danger h-100">
                    <div class="card-body" onclick="getStatusData('{{ PreauthRegister::STATUS_ACS_REJECTED }}')">
                        <div class="d-flex align-items-center mb-2">
                            <div class="avatar me-4">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card card-border-shadow-info h-100">
                    <div class="card-body" onclick="getStatusData('{{ PreauthRegister::STATUS_ACS_QUERIED }}')">
                        <div class="d-flex align-items-center mb-2">
                            <div class="avatar me-4">
                    ...
                    <div class="card-body p-0 demo-vertical-spacing demo-only-element">
                        <div class="form-floating form-floating-outline">
                            <select class="form-select select2" id="status"
                                ...
                                <option value="{{PreauthRegister::STATUS_ACS_PENDING}}" selected>Preauthorization Pending</option>
                                <option value="{{PreauthRegister::STATUS_PREAUTH_APPROVED}}">Preauthorization Approved</option>
                                <option value="{{PreauthRegister::STATUS_ACS_REJECTED}}">Preauthorization Rejected</option>
                                <option value="{{PreauthRegister::STATUS_ACS_QUERIED}}">Preauthorization Queried</option>
                            </select>
...
@push('scripts')
<script>
    function generate_dt(url = "{{ route('acschairman.dashboard-users') }}") {
