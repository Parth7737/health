    ...
    <div class="row">
        <div class="bs-stepper-content">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('acschairman.dashboard') }}" class="btn btn-outline-primary">Back</a>
            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div
                                ...
                                <select class="form-select select2" id="status" name="status">
                                    <option value=""></option>
                                    <option value="{{PreauthRegister::STATUS_ACS_PENDING}}">Preauthorization Pending</option>
                                    <option value="{{PreauthRegister::STATUS_ACS_APPROVED}}">Preauthorization Approved</option>
...
<script>
    ...
    function generate_dt(){
        ...
        dt_ajax = $('.datatables-ajax').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('acschairman.loadcasesearch') }}",
                type: "POST",
                headers: {
