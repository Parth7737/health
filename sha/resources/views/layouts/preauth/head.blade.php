   ...
   <link rel="preconnect" href="https://fonts.googleapis.com" />
    ...
    <link rel="stylesheet" href="{{asset('public/front/assets/vendor/libs/sweetalert2/sweetalert2.css')}}" />
    ...
    <link rel="stylesheet" href="{{asset('public/front/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css')}}" />
