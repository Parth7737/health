...
<head>
    ...
    @include('layouts.ppd.head')
</head>

<body>
<div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
        <div class="layout-container">
            @include('layouts.ppd.header')
                            ...
                            <div class="row g-0">
                                ...
                                <div class="d-flex align-items-center bg-theme-color arrow">
                                        <ul class="menu-list mb-0 py-2  d-flex">
                                            <li class="menu-item">
                                            <a href="{{ route('ppd.dashboard') }}" class="menu-link bottom-menu-icons">
