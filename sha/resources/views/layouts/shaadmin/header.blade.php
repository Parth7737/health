    ...
    <div class="container-xxl">
        <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-6">
            <a href="{{\App\CentralLogics\Helpers::getDashboardRedirect(auth()->user())}}" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo menu-text text-white fw-semibold">
                    {{ optional(auth()->user()->hospital)->facility_name ?ucwords(auth()->user()->hospital->facility_name)." (".auth()->user()->hospital->hospital_id.")": 'SHA: UTTRAKHAND' }}
                </span>
            </a>
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-4 me-xl-1" id="NotificationData">
                    <a class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" href="javascript:void(0);" onclick="fetchNotifications();" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                        <i class="ri-notification-2-line ri-22px"></i>
                        <div class="isNew " style="display:none;">
                            <span class="position-absolute top-0 start-50 translate-middle-y badge badge-dot bg-danger mt-2 border"></span>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end py-0" id="NotificationContent">
