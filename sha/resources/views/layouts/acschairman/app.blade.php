...
<head>
    ...
    @include('layouts.acschairman.head')
</head>

<body>
<div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
        <div class="layout-container">
            @include('layouts.acschairman.header')
            <div class="layout-page">
                <div class="content-wrapper">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="d-flex align-items-center bg-theme-color arrow">
                                        <ul class="menu-list mb-0 py-2  d-flex">
                                            <li class="menu-item">
                                            <a href="{{ route('acschairman.dashboard') }}" class="menu-link bottom-menu-icons">
                    ...
                    @include('layouts.acschairman.footer')
    ...
    @include('layouts.acschairman.scripts')
    <script>
        @if(isset($pending_since))
