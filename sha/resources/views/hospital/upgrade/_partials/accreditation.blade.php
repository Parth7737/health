		...
		<div class="row mt-3 g-5 accreditation-field {{ @$hospital_accreditation->accreditation && $hospital_accreditation->accreditation=='Yes'?'':'d-none' }}">
			...
			<div class="col-md-6 col-lg-3">
				<div class="form-floating form-floating-outline">
					<input type="text" id="certificate_no" name="certificate_no" oninput="sanitize(this, 'b');" class="form-control" placeholder="Certificate Number" value="{{ @$hospital_accreditation->certificate_no }}" />
					<label for="certificate_no">Certificate Number <span class="text-danger">*</span></label>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="form-floating form-floating-outline">
					<input type="text" id="bs-rangepicker-singleee" name="valid_from" class="form-control" placeholder="Valid From" value="{{ @$hospital_accreditation->valid_from }}" />
					<label for="bs-rangepicker-singleee">Valid From <span class="text-danger">*</span></label>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
				<div class="form-floating form-floating-outline">
					<input type="text" id="bs-rangepicker-singleee-2" name="valid_till" class="form-control" placeholder="Valid Till" value="{{ @$hospital_accreditation->valid_till }}" />
					<label for="bs-rangepicker-singleee-2">Valid Till <span class="text-danger">*</span></label>
				</div>
			</div>
			<div class="col-md-6 col-lg-3">
...
<script>
	...
	bsRangePickerSingle = $('#bs-rangepicker-singleee'),
   	bsRangePickerSingle2 = $('#bs-rangepicker-singleee-2');
	...
	$('.saveaccreditation').click(function () {
		swal({
            ...
            if(willDelete) {
				...
				$.ajax({
					url: '{{route("hospital.UaccreditationForm", [$uuid, $hospital_id])}}', // Replace with your server endpoint
					headers: {
