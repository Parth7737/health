...
<div class="accordion accordion-popout mt-4" id="accordionSUBPopout">
	<div class="accordion-item financial_informationsteptab ">
		<h2 class="accordion-header" id="headingPopoutOne">
			<button type="button" class="accordion-button financial_informationstep  theme-color collapsed"
		...
		<div id="accordionSUBPopoutOne"
			...
			<div class="accordion-body">
				<div class="inside-left-info-box success mt-4 bankpanel">
					...
					<form onSubmit="return false" id="financialForm">
						<div class="row mt-3 g-5">
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="account_no" oninput="accountnumber(this);" name="account_no" class="form-control" placeholder="Account Number" value="{{ @$financial_information->account_no }}" />
									<label for="account_no">Account Number <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="account_no_confirmation" name="account_no_confirmation" class="form-control"  oninput="accountnumber(this);"  placeholder="Confirm Account Number" value="{{ @$financial_information->account_no }}" />
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="bank_name" oninput="sanitize(this, 't');" name="bank_name" class="form-control" placeholder="Bank Name" value="{{ @$financial_information->bank_name }}" />
									<label for="bank_name">Bank Name <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="bank_branch_name" name="bank_branch_name" oninput="sanitize(this, 't');" class="form-control" placeholder="Bank Branch Name" value="{{ @$financial_information->bank_branch_name }}" />
									<label for="bank_branch_name">Bank Branch Name <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="bank_address" oninput="sanitize(this, 'm');" name="bank_address" class="form-control" placeholder="Bank Address" value="{{ @$financial_information->bank_address }}" />
									<label for="bank_address">Bank Address <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="micr" oninput="micrnumber(this);" name="micr" class="form-control" placeholder="400002018" value="{{ @$financial_information->micr }}" />
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="authorised_signatory_name" oninput="sanitize(this, 't');" name="authorised_signatory_name" class="form-control" placeholder="Authorised Signatory Name" value="{{ @$financial_information->authorised_signatory_name }}" />
									<label for="certificate_no">Authorised Signatory Name <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="email" id="bank_email" oninput="sanitize(this, 'email');" name="bank_email" class="form-control" placeholder="Bank Email" value="{{ @$financial_information->bank_email }}" />
	...
	<div class="accordion-item taxdetailssteptab">
		<h2 class="accordion-header" id="headingPopoutTwo">
			<button type="button"
				class="accordion-button taxdetailsstep theme-color collapsed"
				data-bs-toggle="collapse"
		...
		<div id="accordionSUBPopoutTwo" class="accordion-collapse taxdetailsstepcollapse collapse"
			...
			data-bs-parent="#accordionSUBPopout">
			<div class="accordion-body">
				<div class="inside-left-info-box success mt-4 taxpanel">
					...
					<form onSubmit="return false" id="taxdetailsForm">
						<div class="row mt-3 g-5">
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="pan_no" oninput="pancard(this);" readonly name="pan_no" class="form-control" placeholder="AAAAA1111A" value="{{ @$tax_details->pan_no }}" />
									<label for="pan_no">PAN Number <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="pan_name" name="pan_name" oninput="sanitize(this, 't');" class="form-control" placeholder="Name on PAN" value="{{ @$tax_details->pan_name }}" />
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="tan_holder_name" name="tan_holder_name" oninput="sanitize(this, 't');" class="form-control" placeholder="TAN Holder Name" value="{{ @$tax_details->tan_holder_name }}" />
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="gst_name" name="gst_name" oninput="sanitize(this, 't');" class="form-control" placeholder="Name on GST Certificate" value="{{ @$tax_details->gst_name }}" />
						...
						<div class="row mt-3 g-5 exemption-field {{ @$tax_details->tds_exemption && $tax_details->tds_exemption=='Yes'?'':'d-none' }}">
							...
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="tds_exemption_certificate_no" oninput="sanitize(this, 'b');" name="tds_exemption_certificate_no" class="form-control" placeholder="TDS Exemption Certificate Number" value="{{ @$tax_details->tds_exemption_certificate_no }}" />
									<label for="tds_exemption_certificate_no">TDS Exemption Certificate Number <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="bs-rangepicker-singlee2" name="tds_exemption_valid_from" class="form-control" placeholder="Valid From" value="{{ @$tax_details->tds_exemption_valid_from }}" />
									<label for="bs-rangepicker-singlee2">TDS Exemption Valid From <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
									<input type="text" id="bs-rangepicker-singlee2-2" name="tds_exemption_valid_till" class="form-control" placeholder="Valid Till" value="{{ @$tax_details->tds_exemption_valid_till }}" />
									<label for="bs-rangepicker-singlee2-2">Valid Till <span class="text-danger">*</span></label>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="form-floating form-floating-outline">
...
<script>
    bsRangePickerSingle = $('#bs-rangepicker-singlee2'),
    bsRangePickerSingle2 = $('#bs-rangepicker-singlee2-2');
	...
	$('.savefinancialinforamation').click(function () {
		swal({
            ...
            if(willDelete) {
				...
				$.ajax({
					url: '{{route("hospital.UfinancialForm", [$uuid, $hospital_id])}}', // Replace with your server endpoint
					headers: {
						...
						if(response.success) {
							...
							swal({
								...
								if (willSubmit) {
									...
									$(`.step10`).addClass('show active');
									$(`.navstep10`).addClass('active');
									setTimeout(() => {
										$(`.step10`).on('click', function(event) {
	...
	$('.savetaxdetails').click(function () {
		swal({
            ...
            if(willDelete) {
				...
				$.ajax({
					url: '{{route("hospital.UtaxdetailsForm", [$uuid, $hospital_id])}}', // Replace with your server endpoint
					headers: {
						'X-CSRF-TOKEN': '{{ csrf_token() }}'
					},
					type: 'POST',
