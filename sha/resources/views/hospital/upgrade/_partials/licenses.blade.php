      ...
      <table class="table table-bordered">
         ...
         <tbody
            ...
            @php
			   ...
			   $existData = App\CentralLogics\Helpers::getUSingleLicense($hospital_id, $value->id, $v->id);
            @endphp
            <tr>
               <td>
                  {{$k+1}}
   ...
   $('.savelicense').click(function () {
      swal({
         ...
         if(willDelete) {
            ...
            $.ajax({
               url: '{{route("hospital.upgrade-licenses-details", [$uuid, $hospital_id])}}', // Replace with your server endpoint
               headers: {
