            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-3 ">
                    <div class="input-group input-group-merge mhrhprdiv hrerror">
                        ...
                        <button class="input-group-text btnhprinput" type="button" onclick="verifymhrhpr('healthcare_proffessionals_registry_id', 'btnhprinput');">Verify</button>
                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating form-floating-outline hrerror">
                        <input type="text" id="name" oninput="sanitize(this, 't');" name="name" required class="form-control name" placeholder="" />
...
<script>
    ...
    function verifymhrhpr(id = '', classname = '') {
            ...
            if(willDelete) {  
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ldrhide();
                        successMessage(response.message);
                        $('.edithrform').addClass('d-none').html("");
                        $('.addhrform').removeClass('d-none');
                        loadHrTable();            
                    },
                    error: function (xhr) {
                        ldrhide();
    ...
    function editHrData(id, hospital_id, type) {
        ldrshow();
        var type = type;
        $.ajax({
            ...
            success: function (response) {
                ldrhide();
                $('.edithrform').removeClass('d-none').html(response.html || response);
                loadSelect2();
                $('.addhrform').addClass('d-none');
            },
            error: function (xhr) {
                ldrhide();
            }
