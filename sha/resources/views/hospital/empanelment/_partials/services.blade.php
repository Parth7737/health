      ...
      <table class="table table-bordered">
         ...
         <tbody
            ...
            @php
               ...
               $existData = App\CentralLogics\Helpers::getSingleServices($hospital_id, $value->id, $v->id);
            @endphp
            <tr>
               <td>
                  {{$k+1}}
...
<script>
   ...
   $('.saveservices').click(function () {
      ...
      $.ajax({
         url: '{{route("hospital.empanelmentRegistration.saveServices", [$uuid, $hospital_id])}}', // Replace with your server endpoint
         headers: {
