        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                <div
                    ...
                    <div
                        class="form-floating form-floating-outline">
                        <input type="text" class="form-control" id="email" oninput="sanitize(this, 'email');" placeholder="john.doe" value="{{auth()->user()->email}}" readonly aria-label="Recipient's username" aria-describedby="email">
