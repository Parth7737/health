...
<aside id="layout-menu"
   ...
   <div class="w-100 h-100">
      <div class="row g-0">
         ...
         <div class="col-md-7">
                <h5 class=" mt-3">{{$hospital->facility_name}}</h5>
         </div>
      </div>
   </div>
</aside>
        ...
        <div class="bs-stepper-content">        
            <div class="bs-stepper wizard-numbered mt-2">
                <div class="bs-stepper-header">
                    ...
                    <div class="line {{$allStepComplete ? 'active' : ''}}"></div>
                    <div class="step {{$allStepComplete ? 'completed disabled crossed' : 'active'}}" data-target="#personal-info">
                        <button type="button" class="step-trigger">
                            <span class="bs-stepper-circle"><i class="ri-check-line"></i></span>
                            <span class="bs-stepper-label">
                    ...
                    <div class="line {{$allStepComplete ? 'active' : 'active'}}"></div>
                    <div class="step @if(@$hospital->dec_change_date) completed disabled crossed @else active @endif" data-target="#social-links">
                        <button type="button" class="step-trigger">
                            <span class="bs-stepper-circle"><i class="ri-check-line"></i></span>
                            <span class="bs-stepper-label">
                            ...
                            <span class="d-flex flex-column gap-1 ms-2">
                                ...
                                <span class="bs-stepper-subtitle">  @if(@$hospital->dec_change_date)<span class="bs-stepper-subtitle">({{date('d/m/Y', strtotime(@$hospital->dec_change_date))}})</span>@endif</span>
                            </span>
                            </span>
                        </button>
                    </div>
                    <div class="line @if(@$hospital->dec_change_date) active @endif"></div>
                    <div class="step @if(@$hospital->sec_change_date) completed disabled crossed @else active @endif" data-target="#claim-pending">
                        <button type="button" class="step-trigger">
                            <span class="bs-stepper-circle"><i class="ri-check-line"></i></span>
                            <span class="bs-stepper-label">
                            <!-- <span class="bs-stepper-number">03</span> -->
                            <span class="d-flex flex-column gap-1 ms-2">
                                ...
                                <span class="bs-stepper-subtitle">@if(@$hospital->sec_change_date)<span class="bs-stepper-subtitle">({{date('d/m/Y', strtotime(@$hospital->sec_change_date))}})</span>@endif</span>
                            </span>
                            </span>
                        </button>
                    </div>
                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="personal-info" class="content active">
                        ...
                        <div class="accordion accordion-popout mt-4" id="accordionPopout1">
                            <div class="accordion-item ">
                                <h2 class="accordion-header" id="headingPopoutOne1">
                                    <button type="button" class="accordion-button theme-color collapsed"
                                        data-bs-toggle="collapse"
                                        data-bs-target="#accordionPopoutOne1" aria-expanded="true"
                                        aria-controls="accordionPopoutOne1">
                                        Establishment Details & Address
                                    </button>
                                </h2>
                                <div id="accordionPopoutOne1"
                                    class="accordion-collapse collapse"
                                    aria-labelledby="headingPopoutOne1"
                                    data-bs-parent="#accordionPopout1">
                                    ...
                                    <div class="card shadow-none border-0 p-0 mb-6">
                                        ...
                                        <div class="nav-align-top">
                                            <ul class="nav nav-tabs ct-tabs" role="tablist">
                                                <li class="nav-item">
                                                    ...
                                                    Scheme
                                                    @if($hospital->scheme != '' && $hospital->image != '')
                                                        @php($step1img = true)
                                                    @else
                                                        @php($step1img = false)
                                                    @endif
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    @if($hospital->financialInformation != '' && $hospital->taxDetails != '')
                                                        @php($step7img = true)
                                                    @else
                                                        @php($step7img = false)
                                                    @endif
                                        ...
                                        <div class="card-body px-0 pt-5">
                                            <div class="tab-content p-0">
                                                <div class="tab-pane fade step1"
                                                    id="tab-scheme" role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step2" id="tab-speciality"
                                                    role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step3" id="tab-services"
                                                    role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step4" id="tab-lincences"
                                                    role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step5" id="tab-human"
                                                 role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step6" id="tab-quality-accerditation"
                                                    role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step7" id="tab-financial"
                                                    role="tabpanel">
                                                </div>
                                                <div class="tab-pane fade step8" id="tab-documents"
                                                    role="tabpanel">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            ...
                            @if($hospital->status != 'Empannelled')
                                <!-- <button type="button" @if(!$allStepComplete) style="display:none" @endif class="btn btn-outline-primary rounded-0 previewsubmit "  >SUBMIT</button> -->
                            @endif
                        </div>
                    </div>
                    <!-- Social Links -->
                        ...
                        <div class="row row-cols-5">
                            <div class="col">
                                <div class="infodata">
                                    ...
                                    <p><strong>{{ @$hospital->hospitalAddress->city }}</strong></p>
                                    <label>Block</label>
                                    <p><strong>{{ @$hospital->block }}</strong></p>
                                    <label>Mobile No</label>
                                    <p><strong>{{ @$hospital->hospitalAddress->mobile_no }}</strong></p>                                           
                                </div>
                            </div>
...
@push('scripts')
    <script>
        ...
        function loadStep(step) {
            ...
            if(step != ""){
                $.ajax({
                    url: '{{route("hospital.empanelmentRegistration.stepLoad", [$uuid, $hospital->id])}}', 
                    type: 'POST',
                    data: {
                        '_token': '{{csrf_token()}}',
                        'step' : step
        ...
        $("#preview").on("click",function(){
            ldrshow();
            $.ajax({
                url: '{{route("hospital.empanelmentRegistration.preview", [$uuid, $hospital->id])}}',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                },
                type: 'POST',
