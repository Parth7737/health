@extends('layouts.admin.app',['main_li'=>'Implants','sub_li'=>'Create Implant'])
@section('title','Create Implant')
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Implant</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_of_multiplier" id="no_of_multiplier">
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
