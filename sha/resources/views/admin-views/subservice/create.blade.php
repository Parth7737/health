@extends('layouts.admin.app',['main_li'=>'Sub Service','sub_li'=>'Create Sub Service'])
@section('title','Create SubService')
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Sub Service</h4>
            </div>
            <form onSubmit="return false" id="implantForm">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="is_required">Is Required <input type="checkbox" class="" name="is_required" id="is_required" value="1"></label>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 req_when" style="display:none;">
                            <div class="form-group">
                                ...
                                <small>If you not select any it will consider required in all speciality type.</small>
                            </div>
                        </div>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody class="body">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" required name="label[]" id="label0" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="value[]" id="value0" class="form-control">
                                    </td>
                                    <td>
                                        <input type="checkbox" name="is_text_input[]" id="is_text_input0" class="">
                                    </td>
                                    <td>
                                        <input type="checkbox" name="is_image[]" id="is_image0" class="">
                                    </td>
                                    <td>
                                        <input type="text" name="sublabel[]" id="sublabel0" class="form-control">
                                    </td>
                                    <td>
                                        <input type="checkbox" name="bed_count[]" id="bed_count0" class="">
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot>
                ...
                <div class="card-action">
                    <button class="btn btn-success" id="add-implant-btn">Save</button>
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function() {
    var rowIndex = 1; // Start from 1 since the first row has index 0
    ...
    $('#addmore').click(function() {
        var newRow = `
            <tr>
                ...
                <td>
                    <input type="checkbox" name="bed_count[]" id="bed_count${rowIndex}" class="">
                </td>
                <td>
...
<script>
    ...
    $("#add-implant-btn").on("click",function(){
        var formData = new FormData($('#implantForm')[0]);
        
        $('.error').remove();
        $.ajax({
            url: '{{route("admin.sub-service.store")}}',
            headers: {
