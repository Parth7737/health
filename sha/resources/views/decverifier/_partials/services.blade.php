      ...
      <table class="table table-bordered">
         <thead class="table-dark">
            <tr>
               ...
               <th style="width: 45%">Verifier Action</th>
               <th>Remarks</th>
            </tr>
         </thead>
         <tbody
...
<script>
   ...
   $('.saveservices').click(function () {
      ...
      $.ajax({
         url: '{{route("decverifier.saveServicesReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}', // Replace with your server endpoint
         headers: {
