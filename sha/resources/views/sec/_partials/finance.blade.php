                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select disabled class="select2 financeerror" id="dec_statussfinance" name="dec_status" required>
                                            <option value="">Select</option>
                                            <option value="Valid" @if(@$hospital->financialInformation->dec_status == "Valid") selected @endif >Valid</option>
                                            <option value="InValid"  @if(@$hospital->financialInformation->dec_status == "InValid") selected @endif >InValid</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            id="dec_remark"
                                            name="dec_remark"
                                            value="{{@$hospital->financialInformation->dec_remark}}"
                                            class="form-control financeerror"
                                            placeholder="text" />
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 financeerror" id="sec_statussfinance" name="sec_status" required>
                                            <option value="">Select</option>
                                            <option value="Valid" @if(@$hospital->financialInformation->sec_status == "Valid") selected @endif >Valid</option>
                                            <option value="InValid"  @if(@$hospital->financialInformation->sec_status == "InValid") selected @endif >InValid</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            value="{{@$hospital->financialInformation->sec_remark}}"
                                            class="form-control financeerror"
                                            placeholder="text" />
                                    </div>
                                </td>
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select disabled class="select2 taxationerror" id="dec_statusstaxation" name="dec_status" required>
                                            <option value="">Select</option>
                                            <option value="Valid" @if(@$hospital->taxDetails->dec_status == "Valid") selected @endif >Valid</option>
                                            <option value="InValid"  @if(@$hospital->taxDetails->dec_status == "InValid") selected @endif >InValid</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            id="dec_remark"
                                            name="dec_remark"
                                            value="{{@$hospital->taxDetails->dec_remark}}"
                                            class="form-control taxationerror"
                                            placeholder="text"/>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <select class="select2 taxationerror" id="sec_statusstaxation" name="sec_status" required>
                                            <option value="">Select</option>
                                            <option value="Valid" @if(@$hospital->taxDetails->sec_status == "Valid") selected @endif >Valid</option>
                                            <option value="InValid"  @if(@$hospital->taxDetails->sec_status == "InValid") selected @endif >InValid</option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            name="sec_remark"
                                            oninput="sanitize(this, 'b');"
                                            value="{{@$hospital->taxDetails->sec_remark}}"
                                            class="form-control taxationerror"
                                            placeholder="text"/>
                                    </div>
                                </td>
...
$('.savefinancialInfo').on('click', function() {
    ...
    $.ajax({
        url: '{{route("sec.saveFinancialReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
        headers: {
...
$('.savetaxationFormInfo').on('click', function() {
    ...
    $.ajax({
        url: '{{route("sec.saveTaxdetailsReview", [base64_encode($hospital->id), base64_encode($hospital->uuid)])}}',
        headers: {
            'X-CSRF-TOKEN': '{{ csrf_token() }}'
        },
        type: 'POST',
