                ...
                <form id="verificationForm">               
                    <div class="row g-5">                    
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" id="verification_type" readonly value="Empanelment" name="verification_type" class="form-control aerrormesage" placeholder="Verification Type" required />
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control datepicker aerrormesage" id="due_date_of_physical_verification" disabled value="{{ date('Y-m-d', strtotime('+7 days')) }}" placeholder="YYYY-MM-DD" name="due_date_of_physical_verification" >
                        </div>
