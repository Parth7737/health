...
@php
    ...
    $cpdDetails = json_decode($preauth_register->cpd_extra_details, true);
    ...
    <div class="row">
        <div class="bs-stepper-content">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
                @include('aco._partials.preauth-step')
                <div class="bs-stepper-content">
                    <!-- Account Details -->
                        ...
                        <div class="accordion accordion-popout mt-4" id="accordionPopout">
                            ...
                            <div class="accordion-item ">
                                <h2 class="accordion-header" id="headingPopoutOne">
                                    <button type="button" class="accordion-button theme-color Medical_Information "
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingPopoutThree">
                                    <button type="button"
                                        class="accordion-button Treatment theme-color collapsed"
                                        data-bs-toggle="collapse"
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('aco._partials.diagnosis')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody
                                                                ...
                                                                @include('aco._partials.procedures')
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingPopoutTwo">
                                    <button type="button"
                                        class="accordion-button Admission_Informations theme-color "
                                        data-bs-toggle="collapse"
                                ...
                                <div id="accordionPopoutTwo" class="accordion-collapse show collapse"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingPopoutFour">
                                    <button type="button"
                                        class="accordion-button finance-color Finance theme-color collapsed"
                                        data-bs-toggle="collapse"
                                ...
                                <div id="accordionPopoutFour"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row g-5 mt-2">
                                            <h5 class="theme-color">CPD (Observation)</h5>
                                            <div class="col-12">
                                                @if($cpdDetails)
                                                <table class="table">
                                                    <thead class="table-white">
                                                        @foreach($cpdDetails as $key => $detail)
                                                        <tr class="border-1">
                                                            <th class=" p-2">{{ $detail['name'] }}</th>
                                                            <th class=" p-2">@if($detail['radio_value'] == 'Y') <span class="text-primary"><strong>Yes</strong></span> @else <span class="text-danger"><strong>No</strong></span> @endif</th>
                                                        </tr>
                                                        @endforeach
                                                    </thead>
                                                </table>
                                        ...
                                        @if($preauth_register->status == PreauthRegister::STATUS_CLAIM_APPROVED)
                                            <form onSubmit="return false" id="approveRejectPreauthForm">
                                                ...
                                                <div class="row g-5">
                                                    <div class="col-12">
                                                        ...
                                                        <ul class="d-flex listing-right finance-total-body">
                                                            @include('aco._partials.finance-total')
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-5">
                                                    <h5 class="theme-color">Hospital Account Details</h5>
                                                    <div class="col-12">
                                                        <div class="table-responsive text-nowrap">
                                                            <table class="table">
                                                                <thead class="table-dark">
                                                                    <tr>
                                                                        <th><strong>Bank Name:</strong> {{@$preauth_register->hospital->financialInformation->bank_name}}</th>
                                                                        <th><strong>Bank Id:</strong> {{@$preauth_register->hospital->financialInformation->bank_branch_name}}</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><strong>Account Type:</strong> {{@$preauth_register->hospital->financialInformation->account_type}}</th>
                                                                        <th><strong>Account Name:</strong> {{@$preauth_register->hospital->financialInformation->account_holder}}</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><strong>IFSC Code:</strong> {{@$preauth_register->hospital->financialInformation->ifsc_code}}</th>
                                                                        <th><strong>Account Number:</strong> {{@$preauth_register->hospital->financialInformation->account_no}}</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><strong>Pan Card Number:</strong> {{@$preauth_register->hospital->taxDetails->pan_no}}</th>
                                                                        <th><strong>Pan Card Name:</strong> {{@$preauth_register->hospital->taxDetails->pan_name}}</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>
                                                                            <strong>Cancel Check:</strong> <label class="mt-2">&nbsp; <a href="{{ asset('public/storage/'.@$preauth_register->hospital->financialInformation->cancelled_cheque) }}" target="_blank" class="btn btn-outline-primary btn-sm">View Document</a></label>
                                                                        </th>
                                                                        <th>
                                                                            <strong>Pan Card Certificate:</strong> <label class="mt-2">&nbsp; <a href="{{ asset('public/storage/'.@$preauth_register->hospital->taxDetails->pan_certificate) }}" target="_blank" class="btn btn-outline-primary btn-sm">View Document</a></label>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                            </table>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="table-responsive  text-nowrap">
                                                            <table class="table">
                                                                <thead class="table-dark">
                                                                    <tr>
                                                                        <th><strong class="theme-color">Bank Amount Details as per HEM record:</strong>&nbsp;&nbsp;
                                                                        <strong>Bank Account No: </strong> {{@$preauth_register->hospital->financialInformation->account_no}}
                                                                        &nbsp;|&nbsp;<strong>IFSC Code: </strong> {{@$preauth_register->hospital->financialInformation->ifsc_code}}
                                                                        </th>
                                                                        <th class="float-left p-3">
                                                                            <div class="d-flex errormesage">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input" type="radio" name="bank_details" id="bank_details" value="Correct" checked>
                                                                                    <label class="form-check-label" for="bank_details">
                                                                                        Correct
                                                                                    </label>
                                                                                </div>
                                                                                <div class="form-check ms-4">
                                                                                    <input class="form-check-input" type="radio" name="bank_details" id="bank_details2" value="InCorrect" >
                                                                                    <label class="form-check-label" for="bank_details2">
                                                                                        InCorrect
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <th><strong class="theme-color">TDS Details as per HEM Records:</strong>&nbsp;&nbsp;<strong>TDS % : </strong> 
                                                                        {{@$preauth_register->hospital->taxDetails->tds_exemption == 'No' && @$preauth_register->hospital->facilityOwnershipType->name == 'Private'? 'Applicable' : 'Not Applicable'}}</th>
                                                                        <th class="float-left p-3">
                                                                            <div class="d-flex errormesage">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input" type="radio" name="tds_details" id="tds_details" value="Correct" checked>
                                                                                    <label class="form-check-label" for="tds_details">
                                                                                        Correct
                                                                                    </label>
                                                                                </div>
                                                                                <div class="form-check ms-4">
                                                                                    <input class="form-check-input" type="radio" name="tds_details" id="tds_details2" value="InCorrect" >
                                                                                    <label class="form-check-label" for="tds_details2">
                                                                                        InCorrect
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <th><strong class="theme-color">Is This is a Duplicate Bil?</strong>&nbsp;&nbsp;&nbsp; <strong>Bill No:</strong> 
                                                                        {{@$preauth_register->bill_no}}&nbsp;&nbsp;|&nbsp;&nbsp;
                                                                        <strong>Bill Date:</strong> 
                                                                        {{@$preauth_register->bill_date}}</th>
                                                                        <th class="float-left p-3">
                                                                            <div class="d-flex errormesage">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input" type="radio" name="duplicate_bill" id="duplicate_bill" value="Yes" checked>
                                                                                    <label class="form-check-label" for="duplicate_bill">
                                                                                        Yes
                                                                                    </label>
                                                                                </div>
                                                                                <div class="form-check ms-4">
                                                                                    <input class="form-check-input" type="radio" name="duplicate_bill" id="duplicate_bill2" value="No" checked >
                                                                                    <label class="form-check-label" for="duplicate_bill2">
                                                                                        No
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <th><strong class="theme-color">Recovery Amount Adjusted</strong> {{@$bankdetails->ifsc_code}}</th>
                                                                        <th class="float-left p-3">
                                                                            <div class="d-flex errormesage">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input" type="radio" name="recovery_amount_adjusted" id="recovery_amount_adjusted" value="Yes" >
                                                                                    <label class="form-check-label" for="recovery_amount_adjusted">
                                                                                        Yes
                                                                                    </label>
                                                                                </div>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <div class="form-floating form-floating-outline mb-6 cexerror">
                                                        <textarea class="form-control h-px-100" id="aco_remark" name="aco_remark" placeholder="Write remarks here..."></textarea>
                                                        <label for="remarks">Remarks<span class="text-danger">*</span></label>
                                                    </div>
                                                    <input type="hidden" name="preauth_register_id" value="{{ $preauth_register->id }}">
                                                </div>
                                                @if($preauth_register->claim_approve_remarks && $preauth_register->status == PreauthRegister::STATUS_CLAIM_APPROVED)
                                                    <div class="col-md-12 mt-2">
                                                        <div class="form-floating form-floating-outline mb-6">
                                                            <textarea class="form-control h-px-50 text-primary" disabled >{{$preauth_register->claim_approve_remarks}}</textarea>
                                                            <label for="remarks">CPD Remarks</label>
                                                        </div>
                                                    </div>
                                                @endif
                                                <div class="row ">
                                        ...
                                        @endif
                                        @if($preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_CLAIM_APPROVED)
                                            <div class="erroneous-form">
                                                <form onSubmit="return false" id="approveRejectErroneousClaimForm">
                                                    ...
                                                    @if($preauth_register->erroneous_remarks && $preauth_register->status == PreauthRegister::STATUS_ERRONEOUS_CLAIM_APPROVED)
                                                        <div class="col-md-12 mt-2">
                                                            <div class="form-floating form-floating-outline mb-6">
                                                                <textarea class="form-control h-px-50 text-success" disabled >{{$preauth_register->erroneous_remarks}}</textarea>
                                                                <label for="remarks">Erroneous Remarks by CPD</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="row ">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success){
                            ...
                            setTimeout(() => {
                                window.location.href="{{ route('aco.dashboard') }}";
                            }, 1000);
                        }else{
    ...
    $("#erroneous-claim-btn").on("click",function(){
        ...
        swal({
            ...
            if (willDelete) {
                ...
                $('.error').remove();
                $.ajax({
                    url: '{{route("aco.erroneous-claim-action")}}',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
                    type: 'POST',
