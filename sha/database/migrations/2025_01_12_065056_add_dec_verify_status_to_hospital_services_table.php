...
return new class extends Migration
{
    ...
    {
        Schema::table('hospital_services', function (Blueprint $table) {
            $table->dropColumn(['dec_verify_service_value','dec_verify_text_value','dec_verify_image','dec_verify_remark','dec_verify_id','dec_status','dec_remark','dec_id','sec_status','sec_remark','sec_id']);
        });
    }
};
