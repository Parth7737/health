...
use App\Models\{ User, Hospitals, ExpiredDocument, Notifications, HospitalSpeciality};
use Carbon\Carbon;
...
class DocumentExpiry extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($daysToCheck as $daysLeft) {
            Hospitals::where('status', 'Empanelled')->chunk(50, function ($hospitals) use ($daysLeft) {
