...
class UHospitals extends Model
{
    ...
    public function hospitalAddress() {
        return $this->hasone('App\Models\UHospitalAddress', 'hospital_id');
    }
    ...
    public function specialities() {
        return $this->hasMany('App\Models\UHospitalSpeciality', 'hospital_id');
    }

    public function services() {
        return $this->hasMany('App\Models\UHospitalServices', 'hospital_id');
    }

    public function licenses() {
        return $this->hasMany('App\Models\UHospitalLicense', 'hospital_id');
    }

    public function ceo() {
        return $this->hasOne('App\Models\UHospitalCeo', 'hospital_id');
    }
    public function humanResources() {
        return $this->hasMany('App\Models\UHospitalHumanResource', 'hospital_id');
    }

    public function hospitalTeam() {
        return $this->hasMany('App\Models\UHospitalTeam', 'hospital_id');
    }
    public function hospitalAccreditation() {
        return $this->hasOne('App\Models\UHospitalAccreditation', 'hospital_id');
    }
    public function financialInformation() {
        return $this->hasOne('App\Models\UFinancialInformation', 'hospital_id');
    }
    public function taxDetails() {
        return $this->hasOne('App\Models\UTaxDetails', 'hospital_id');
    }
    
    public function documents() {
        return $this->hasMany('App\Models\UHospitalDocument', 'hospital_id');
    }
    ...
    public function images() {
        return $this->hasMany('App\Models\UHospitalImages', 'hospital_id');
    }
