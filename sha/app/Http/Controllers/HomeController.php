...
use App\Models\{ SchemeType, HospitalState, HospitalType, EmpanelmentType, HospitalDistrict, HospitalSubType, Hospitals, MobileOtp, EmailOtp, PreauthRegister};
use Hash;
use Validator;
use App\Services\BankService;
use App\CentralLogics\Helpers;
use App\Exports\CaseReportData;
...
class HomeController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        $HospitalState = HospitalState::where('country_id', 101)->get();
        $HospitalType = HospitalType::get();
        $EmpanelmentType = EmpanelmentType::get();
        return view('hospital.index', compact('schemeType','HospitalState','HospitalType','EmpanelmentType'));
    }
